...
public class TowerLocationSwapMove extends AbstractMove {
	...
	public boolean isMoveDoable(ScoreDirector scoreDirector) {
		 return !ObjectUtils.equals(tower.getTowerLocation(), otherTower.getTowerLocation());
	}
	...
	public Collection<? extends Object> getPlanningValues() {
		return Arrays.asList(tower.getTowerLocation(), otherTower.getTowerLocation());
	}
	...
	protected void doMoveOnGenuineVariables(ScoreDirector scoreDirector) {
		 ...
		 TowerProblemMoveHelper.moveCellTower(scoreDirector, tower, oldTowerLocation);
		 TowerProblemMoveHelper.moveCellTower(scoreDirector, otherTower, oldOtherTowerLocation);
