...
public class TowerScheduleGenerator
{
   ...
   public TowerSchedule createTowerSchedule(int phones, int towers,
         double phoneRange, double topLeftLat, double topLeftLng,
         double bottomRightLat, double bottomRightLng)
   {
      ...
      schedule.setTowerGrid(createTowerGrid(phoneRange, topLeftLat, topLeftLng,
            bottomRightLat, bottomRightLng, schedule.getPhoneList(),
   ...
   private TowerGrid createTowerGrid(double range, double topLeftCornerLat,
         double topLeftCornerLng, double bottomRightCornerLat,
         double topRightCornerLng, List<CellPhone> phoneList,
         List<CellTower> towerList)
   {
      TowerGrid newGrid = new TowerGrid(range, topLeftCornerLat,
            topLeftCornerLng, bottomRightCornerLat, topRightCornerLng,
            phoneList, towerList);
      return newGrid;
   }
