...
public class TowerScheduleGenerator {
	...
	public TowerSchedule createTowerSchedule(int phones, int towers, double phoneRange, double topLeftLat,
		...
		schedule.setTowerGrid(createTowerGrid(phoneRange, topLeftLat, topLeftLng, bottomRightLat, bottomRightLng,
	...
	private TowerGrid createTowerGrid(double range, double topLeftCornerLat, double topLeftCornerLng,
			double bottomRightCornerLat, double topRightCornerLng, List<CellPhone> phoneList,
			List<CellTower> towerList) {
		TowerGrid newGrid = new TowerGrid(range, topLeftCornerLat, topLeftCornerLng, bottomRightCornerLat,
				topRightCornerLng, phoneList, towerList);
		return newGrid;
	}
	...
	public TowerSchedule createSmallTowerSchedule() {
		...
		schedule.setTowerGrid(createTowerGrid(4000.00, 37.00, -106.00, 36.00, -105.00, schedule.getPhoneList(),
				schedule.getTowerList()));
		schedule.setOptimalScore(schedule.getTowerGrid().getOptimalScore());
		schedule.setPriorityPhones();
		return schedule;
	}
	...
	public TowerSchedule createMediumTowerSchedule() {
		...
		schedule.setTowerGrid(createTowerGrid(4000.00, 33.00, -103.00, 30.00, -100.00, schedule.getPhoneList(),
				schedule.getTowerList()));
		schedule.setOptimalScore(schedule.getTowerGrid().getOptimalScore());
		schedule.setPriorityPhones();
		return schedule;
	...
	public TowerSchedule createLargeTowerSchedule() {
		...
		schedule.setTowerGrid(createTowerGrid(4000.00, 40.00, -110.00, 30.00, -100.00, schedule.getPhoneList(),
				schedule.getTowerList()));
		schedule.setOptimalScore(schedule.getTowerGrid().getOptimalScore());
		schedule.setPriorityPhones();
		return schedule;
	...
	public TowerSchedule createDemoTowerSchedule() {
		...
		schedule.setTowerList(createTowerList(2));
		schedule.setTowerGrid(createTowerGrid(4000.00, 37.00, -101.00, 36.00, -100.00, schedule.getPhoneList(),
				schedule.getTowerList()));
		schedule.setOptimalScore(schedule.getTowerGrid().getOptimalScore());
		schedule.setPriorityPhones();
		return schedule;
	...
	private List<CellPhone> createSmallPhoneList() {
		...
		for (int i = 0; i < 10; i++) {
			CellPhone phone = new CellPhone(4000, (36 + Math.random()), (-106 + Math.random()), 500, false);
			phone.setId(i);
			phoneList.add(phone);
		}
		CellPhone pri1 = new CellPhone(4000, (36 + Math.random()), (-106 + Math.random()), 500, true);
		CellPhone pri2 = new CellPhone(4000, (36 + Math.random()), (-106 + Math.random()), 500, true);
		phoneList.add(pri1);
		phoneList.add(pri2);
		return phoneList;
	}
	...
	private List<CellPhone> createMediumPhoneList() {
		...
		for (int i = 0; i < 80; i++) {
			CellPhone phone = new CellPhone(4000, (ThreadLocalRandom.current().nextDouble(30, 33)),
					(ThreadLocalRandom.current().nextDouble(-103, -100)), 500, false);
			phone.setId(i);
			phoneList.add(phone);
		}
		CellPhone pri1 = new CellPhone(4000, (ThreadLocalRandom.current().nextDouble(30, 33)),
				(ThreadLocalRandom.current().nextDouble(-103, -100)), 500, true);
		CellPhone pri2 = new CellPhone(4000, (ThreadLocalRandom.current().nextDouble(30, 33)),
				(ThreadLocalRandom.current().nextDouble(-103, -100)), 500, true);
		phoneList.add(pri1);
		phoneList.add(pri2);
		return phoneList;
	...
	private List<CellPhone> createLargePhoneList() {
		...
		for (int i = 0; i < 250; i++) {
			CellPhone phone = new CellPhone(4000, (ThreadLocalRandom.current().nextDouble(30, 40)),
					(ThreadLocalRandom.current().nextDouble(-110, -100)), 500, false);
			phone.setId(i);
			phoneList.add(phone);
		}
		CellPhone pri1 = new CellPhone(4000, (ThreadLocalRandom.current().nextDouble(30, 40)),
				(ThreadLocalRandom.current().nextDouble(-110, -100)), 500, true);
		CellPhone pri2 = new CellPhone(4000, (ThreadLocalRandom.current().nextDouble(30, 40)),
				(ThreadLocalRandom.current().nextDouble(-110, -100)), 500, true);
		phoneList.add(pri1);
		phoneList.add(pri2);
		return phoneList;
