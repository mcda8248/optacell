...
public class CellTowerApp
{
    ...
    * <p>
    * Handles arguments to tell it what type of scheduling run to perform.  Use 'save'
    * to save a file containing the problem space generated by this run.  Use 'file'
    * followed by another argument containing the filename to load to import a problem
    * space for this run.  If no argument is provided, it just runs without saving.
    *
