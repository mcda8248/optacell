...
public class CellTowerApp
{
    ...
    * Use 'benchmark' to run benchmarking
   ...
   public static void main(String[] args)
   {
      ...
      if ("benchmark".equals(howToRunArg))
      {
         PlannerBenchmarkFactory pbf =
               PlannerBenchmarkFactory.createFromFreemarkerXmlResource("cellTowerBenchmarkConfiguration.xml.ftl");
         PlannerBenchmark pb = pbf.buildPlannerBenchmark();
         pb.benchmark();
         return;
      }
